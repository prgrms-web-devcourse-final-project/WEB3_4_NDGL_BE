...
public class AuthenticationExceptionLoggingAspect {

	private final ObjectMapper objectMapper;

	// 스프링 시큐리티 Authentication 실패 : 401 예외
	@After("execution(* com.ndgl.spotfinder.global.security.handler.CustomAuthenticationEntryPoint.commence(..))")
	public void logAuthenticationException(JoinPoint joinPoint) throws Throwable {
